...
pub struct LazyPersistent<T: PersistentNode + LazyNode> {
    nodes: Vec<T>,
    roots: Vec<usize>,
    n: usize,
}
    ...
    T: PersistentNode + LazyNode + Clone,
{
    ...
    /// ```
    /// # use seg_tree::{LazyPersistent,utils::{Sum, PersistentWrapper},nodes::Node};
    ...
    /// ```
    /// # use seg_tree::{LazyPersistent,utils::{Max, PersistentWrapper, LazySetWrapper},nodes::Node};
...
mod tests {
    use crate::{
        nodes::Node,
        segment_tree::lazy_persistent::LazyPersistent,
